 ...
 *
 */
public class ActionObject01 extends ActionObject
{
  public ActionObject01()
  {
    super("action001",1);

    addSuccessor( ActionObject02.class);
    addSuccessor( ActionObject03.class);
    addSuccessor( ActionObject08.class);
  }
  ...
  public void reInit(Point startPos)
  {
    ...
    endPosY = startPos.y+ (int)(((screenHeight) / (getRandom(10,30)*getSignum())));
